...
def click(left):
    hWnd = cap.hwnd
    lParam = win32api.MAKELONG(200, 200)
...
while True: 
    ...
    # if game_on:
        ...
        # if left:
            # cv.line(game_frame, (d_l_cord[0]-4, l_found), (d_l_cord[0]-4, d_l_cord[1]), (0, 255, 0), 2)

            # for line in range(d_l_cord[1], 0, -65):
            #     cv.line(game_frame, (d_l_cord[0]-100, line), (d_l_cord[0]-50, line), (0, 255, 0), 2)

        # else:
            # cv.line(game_frame, (d_r_cord[0]+4, r_found), (d_r_cord[0]+4, d_r_cord[1]), (0, 255, 0), 2)
